...
import Backup.Dasboard_AdminDea;
import Backup.Register_AdminDea;
import Backend.*;
import Frontend.*;
...
public class Login_Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("You are a User?");
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        Register_Admin ang = new Register_Admin();
        ang.setVisible(true);
        ang.pack();
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
        String SQL ="SELECT * FROM admin WHERE username_admin = '"+txtUsername.getText()+ "'AND password_admin='"+txtPassword.getText()+"'";
        ResultSet rs = DBHelper.selectQuery(SQL);
            if(rs.next()){
                if(username.equals(rs.getString("username_admin")) && password.equals(rs.getString("password_admin"))){  
                    JOptionPane.showMessageDialog(null,"Selamat,Anda berhasil login");   
                    Dashboard_Admin ang = new Dashboard_Admin();
                    ang.setVisible(true);
                    ang.pack();
                    ang.setLocationRelativeTo(null);
                    ang.setDefaultCloseOperation(Login_Admin.EXIT_ON_CLOSE);
                    this.dispose();
                }
