 ...
 * @author WINDOWS 10
 */
public class Manage_PesawatDea extends javax.swing.JFrame {

    /**
     * Creates new form Dasboard_User
     */
    public Manage_PesawatDea() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manage_PesawatDea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manage_PesawatDea().setVisible(true);
            }
        });
    }
